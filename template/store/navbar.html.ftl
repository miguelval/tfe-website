<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="d-flex flex-column moqui-navbar">
        <div class="container d-flex flex-row main-navbar">
            <a class="navbar-brand d-none d-sm-block"  href="/schoolSuppliesStore">
                <img height="60px" class="moqui-logo moqui-logo1" src="/schoolSuppliesStore/assets/moqui-logo.svg" alt="">
                <span class="font-italic navbar-title">School Supplies</span>
            </a>
            <a class="navbar-brand d-block d-sm-none" href="/schoolSuppliesStore">
                <span class="font-italic navbar-title">School Supplies</span>
            </a>
            ...
            <div class="navbar-collapse collapse">
                ...
                <ul class="navbar-nav ml-auto">
                    <div class="text-secondary">
                        <span class="navbar-pop-title">All the School Supplies </span>
                        <span class="navbar-pop-title">that you need!</span>
                    </div>
                </ul>
            </div>
        </div>
        <div id="nav_collapse1" class="container navbar-collapse collapse">
            <ul class="navbar-nav">
                    <a class="nav-link" href="/schoolSuppliesStore/contact">Contact Us</a>
            </ul>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <#if cartCount gt 0>
                        <a class="nav-link" href="/schoolSuppliesStore/d#/checkout">
                    <#else>

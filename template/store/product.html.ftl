...
<div class="container mt-2">
    <a class="customer-link" href="/schoolSuppliesStore">Home <i class="fas fa-angle-right"></i></a>
...
<div class="container container-text mt-1">
    <#if addedCorrect?? && addedCorrect == 'true'>
        <div class="alert alert-primary mt-3 mb-3" role="alert">
            ...
            <a class="float-right" href="/schoolSuppliesStore/d#/checkout">Go to Checkout <i class="fas fa-arrow-right"></i></a>
        </div>
    </#if>
    ...
    <div class="row mt-2">
        ...
        <div class="col col-lg-3">
            <form class="card cart-div" method="post" action="/schoolSuppliesStore/product/addToCart">
                <div>
...
<script>
    ...
    <#else>
        $productImageLarge.src = "/schoolSuppliesStore/assets/default.png";
    </#if>
